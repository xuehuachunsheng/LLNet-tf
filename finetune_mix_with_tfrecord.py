...
batch_size = 128
stored_ckpt_batches = int(10 * num_train_samples / batch_size)
...
test_path = os.path.join(root_path, 'test_2500patch_per_image.tfrecords')
...
if not continue_train:
    saver.restore(sess, './pretrained_model/whole-pretrained-model-3303360')
...
learning_rate = tf.train.exponential_decay(learning_rate=lr,
                                           ...
                                           decay_steps=int(200 * num_train_samples / batch_size),
                                           decay_rate=0.1,
                                           staircase=True)
